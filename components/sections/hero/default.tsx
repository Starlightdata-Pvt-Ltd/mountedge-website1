...
export default function Hero({
  title = (
  <>
    <h1 className="block -mb-8a text-6xl ">Secure. Scalable.</h1>
    <span className="block text-blue-500 text-6xl  ">Unified Cybersecurity.</span>
  </>
),
  ...
  return (
    <Section
      className={cn(
        "fade-bottom overflow-hidden pb-0 sm:pb-0 md:pb-0 -mt-55",
        className,
      )}
    >
      <div className="max-w-container mx-auto flex flex-col gap-12 pt-16 sm:gap-24">
